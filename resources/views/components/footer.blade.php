    ...
    <footer class="container py-5">
        <div class="row">
            <div class="mb-4">
                ...
                <div class="col-5 col-md-5 mb-3 d-flex">
                    <input type="email" name="email" id="email" class="form-control" required>
                    <a href="#" style="background: linear-gradient(to right, #0A306E, #572BFE);" class="enviar-contato btn btn-sm w-25 text-uppercase mx-2 px-3 py-2 fw-bold text-white">
