    ...
    <footer class="container py-5">
        <div class="row">
            <div class="mb-4 d-flex flex-column justify-content-center col-12 col-md-6">
                ...
                <form action="#">
                    <div class="col-5 col-md-6 mb-3 d-flex">
                        <input type="email" name="email" id="email" class="form-control col-5 text-muted" required>
                        <a href="#" style="background: linear-gradient(to right, #0A306E, #572BFE);" class="enviar-contato btn btn-sm text-uppercase mx-2 px-3 py-2 fw-bold text-white">
                            Enviar
                        </a>
                    </div>
                </form>
            ...
            <!-- <div class="col-6 col-md">
                ...
                <ul class="list-unstyled text-small">
                    ...
                    <li><a class="link-secondary text-decoration-none" href="#">Serviço 2</a></li>
                    <li><a class="link-secondary text-decoration-none" href="#">Serviço 3</a></li>
                    <li><a class="link-secondary text-decoration-none" href="#">Serviço 4</a></li>
