...
<div class="topbar text-white py-2">
    <div class="container d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div class="col-12 col-md-4 d-flex justify-content-center justify-content-md-end gap-4">
            <a href="#" class="text-white"><i class="bi bi-search fs-6"></i></a>
...
<nav class="navbar navbar-expand-md bg-light sticky-top border-bottom" data-bs-theme="light">
    <div class="container">
        <a class="navbar-brand d-md-none" href="#">
            <img src="{{ asset('assets/img/nova_logo.png') }}" class="bi img-fluid" width="100" alt="Logo">
        </a>
                ...
                <ul class="navbar-nav flex-grow-1 justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-style shadow mb-3 bg-body-tertiary rounded">
                            ...
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Governo</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Asseio e conservação</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Gestão de instalações</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Varejo</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Saúde</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Hotalaria</a></li>
                            <li><a class="dropdown-item dropdown-item item-style text-muted pb-2" href="#">Lavanderia comercial</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" aria-label="Cart">
                            <button class="btn btn-success consultor-btn fw-bold text-uppercase">
                                Falar com consultor
                            </button>
                        </a>
                    </li>
